...
var validator = (function($){
    var message, tests, checkField, validate, mark, unmark, field, minmax, defaults,
		...
		mible_filter = /^(13[0-9]{9})|(18[0-9]{9})|(14[0-9]{9})|(17[0-9]{9})|(15[0-9]{9})$/;
    ...
    */
    message = {
        ...
        mobile           : 'mobile address is invalid',
    ...
    */
    tests = {
		...
		mobile : function(a){
            if ( !mobile_filter.test( a ) ){
                alertTxt = a ? message.mobile : message.empty;
                return false;
            }
